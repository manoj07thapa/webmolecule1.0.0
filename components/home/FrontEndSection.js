...
import SeveltImage from "../../public/svelte-1.svg";
import VueImage from "../../public/vue-js-1.svg";
import VuePng from "../../public/App.vue.png";
import RemixPng from "../../public/remix.js.png";
import NextPng from "../../public/Blog.jd.png";

const FrontEndSection = ({ frontendResources }) => {
  return (
    <div className="border-b border-gray-800 py-12">
      {frontendResources.map((item) => (
        <div key={item.id} className="space-y-4">
          <CogIcon className="h-16 w-16 text-indigo-700 text-left" />
